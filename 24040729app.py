...
- "index skrzyni", "indeks skrzyni" → to samo co numer partii ("proNrPartii")
...
### 📋 SZABLON WZORCOWY dla pytań "co pobrano dziś w podziale na twórcę i skrzynię":

SELECT
    pak."pakUserTw" AS "Twórca",
    COALESCE(pak."zadprNrPartii", 'brak') AS "Index skrzyni",
...
GROUP BY pak."pakUserTw", pak."zadprNrPartii", art."artNazwa"
ORDER BY pak."pakUserTw", "Index skrzyni"
LIMIT 1000
