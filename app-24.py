...
SELECT
    ...
    ws."Index skrzyni",
    ws."Nr partii",
    COALESCE(pz."Koszt łączny"::numeric(10,2), 0) AS "Koszt części (zł)",
    COALESCE(pz."Liczba różnych części", 0) AS "Ile rodzajów"
FROM wytworzone_skrzynie AS ws
LEFT JOIN pobrania_z_cenami AS pz ON pz."Nr partii" = ws."Nr partii"
ORDER BY ws."Twórca", ws."Index skrzyni"
LIMIT 1000
