    ...
    if "🚛" in bilans_typ:
        ...
        if dane is None:
            ...
            for k in kurierzy:
                ...
                fig.update_layout(
                    ...
                    plot_bgcolor='white',
                    yaxis=dict(title='tys. PLN', gridcolor='#ECF0F1'),
        ...
        if df_skrz is None or df_skrz.empty:
            ...
            fig.update_layout(
                ...
                plot_bgcolor='white',
                yaxis=dict(title='średni koszt zł/szt', gridcolor='#ECF0F1'),
                xaxis=dict(gridcolor='#ECF0F1'),
        ...
        if dane is None:
            ...
            if df_sprz.empty or df_kszt.empty:
                ...
                fig.update_layout(
                    height=450,
                    plot_bgcolor='white',
                    yaxis=dict(title='Marża /szt (PLN)', gridcolor='#ECF0F1', zerolinecolor='#2C3E50', zerolinewidth=2),
