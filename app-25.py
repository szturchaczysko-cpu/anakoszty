...
with tab_ai:
    ...
    # Pobierz schemat SQL Server (druga gałąź)
    schema_mssql = None
    try:
        with st.spinner("🔵 Pobieram schemat SQL Server (ebayApiDB, STEEPC, SHOP_PMG)..."):
            schema_mssql = pobierz_schema_mssql()
    except Exception as e:
        st.warning(f"Nie udało się pobrać schematu SQL Server: {e}")
